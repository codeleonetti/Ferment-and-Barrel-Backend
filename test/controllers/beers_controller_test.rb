...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { abv: @beer.abv, brewery_id: @beer.brewery_id, ibu: @beer.ibu, img: @beer.img, name: @beer.name, style: @beer.style } }, as: :json
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { abv: @beer.abv, brewery_id: @beer.brewery_id, ibu: @beer.ibu, img: @beer.img, name: @beer.name, style: @beer.style } }, as: :json
    assert_response 200
  end
